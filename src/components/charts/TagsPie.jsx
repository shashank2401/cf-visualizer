...
const COLORS = [
  "#2563eb", "#f59e42", "#10b981", "#f43f5e", "#a21caf", "#facc15", "#14b8a6", "#e11d48", "#64748b", "#6366f1", "#0ea5e9", "#f472b6", "#22d3ee"
];

export default function TagsPie({ data }) {
  if (!data || !data.length) {
    return (
      <div className="w-full h-64 flex items-center justify-center bg-white dark:bg-gray-900 rounded-xl shadow mt-6">
        <span className="text-gray-400 dark:text-gray-600">No tag data available.</span>
      </div>
    );
  }
